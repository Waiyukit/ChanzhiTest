...
public class FreemarkerDemo {
    ...
    private static final String TEMPLATE_PATH = "src/com/freemarker";
    private static final String CLASS_PATH = "src/com/freemarker";
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            dataMap.put("classPath", "com.freemarker");
